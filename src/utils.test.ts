...
describe("getPipedLinks", () => {
    ...
    it("should convert the text content of YouTube links", () => {
        const text =
            "Watch this video: [https://youtube.com/watch?v=dQw4w9WgXcQ](https://youtube.com/watch?v=dQw4w9WgXcQ)";
        const expected = [
            new UrlLink("https://piped.video/watch?v=dQw4w9WgXcQ", "https://piped.video/watch?v=dQw4w9WgXcQ"),
        ];
        expect(getPipedLinks(text)).toEqual(expected);
    });
